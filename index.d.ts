...
export function addUserMessage(text: string, timestamp:Date): void;
export function addUserMessage(text: string, timestamp:Date, id: string): void;

export function addResponseMessage(text: string): void;
export function addResponseMessage(text: string, timestamp:Date): void;
export function addResponseMessage(text: string, timestamp:Date, id: string): void;
