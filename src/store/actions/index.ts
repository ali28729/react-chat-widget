...
export function addUserMessage(text: string, timestamp?: Date, id?: string): actionsTypes.AddUserMessage {
  return {
...
export function addResponseMessage(text: string, timestamp?: Date, id?: string): actionsTypes.AddResponseMessage {
  return {
